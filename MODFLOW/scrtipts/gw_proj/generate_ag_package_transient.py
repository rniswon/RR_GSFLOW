...
def generate_well_list(df_wells):
    ...
    # todo: verify that these conversions are correct.
    #  They don't really make a lot of sense
    df_qmax['Qmax'] = df_qmax['field_area'] * 4.0  # 4.0 ft/yr/ft2
...
def create_irrdiversion_stress_period(stress_period, df_diversion, df_kcs):
    ...
    return irrdiversion, numrecords, 1
...
def main():
    ...
    ag_dataset_file = os.path.join(script_ws, "ag_dataset.csv")
