...
if (update_starting_heads == 1) | (update_starting_parameters == 1):
    ...
    mf_initial_heads_file = r"..\..\..\GSFLOW\scratch\20220915_01_new_exe\modflow\output\rr_tr.hds"  # Temporary
...
if update_ag_package == 1:
    ...
    for div_seg in div_segs:
        ...
        segment_data.loc[seg_mask, 'flow'] = 1e-5      # EXPERIMENT
...
if create_tabfiles_for_pond_diversions == 1:
    ...
    for pond in ponds:
        ...
        pond_list.loc[pond_list_mask, 'q'] = 1e-5        # EXPERIMENT
    ...
    for seg in div_seg:
        ...
        this_tabfile.loc[month_mask_spec_div, 'daily_demand_m3'] = 0   # EXPERIMENT
    ...
    pond_list_file_path = os.path.join(repo_ws, "MODFLOW", "init_files", "pond_list_19a_zero_ag_water_use.csv")
