...
def main():
    ...
    ag_dataset_ponds.to_csv(os.path.join(repo_ws, "MODFLOW", "init_files", "ag_dataset_ponds_zero_ag_water_use.csv"), index=False)
    ...
    ag_dataset_updated_well_ids_file = os.path.join(repo_ws, "MODFLOW", "init_files", "ag_dataset_w_ponds_w_iupseg_w_no_orphans_well_ids_renumbered_zero_ag_water_use.csv")
    ...
    ag_dataset_wells.to_csv(os.path.join(repo_ws, "MODFLOW", "init_files", "ag_dataset_wells_zero_ag_water_use.csv"), index=False)
    ...
    ag_dataset_diversions.to_csv(os.path.join(repo_ws, "MODFLOW", "init_files", "ag_dataset_diversions_zero_ag_water_use.csv"), index=False)
