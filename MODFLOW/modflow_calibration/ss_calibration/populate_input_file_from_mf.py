...
subbasin_file = r".\slave_dir\misc_files\subbasins.txt"
surf_geo_file = r".\slave_dir\misc_files\surface_geology.txt"
mffn = r".\slave_dir\mf_dataset\rr_ss.nam"
zone_file = r".\slave_dir\misc_files\K_zone_ids.dat"
...
for id in sub_ids:
    ...
    param_utils.change_par_value(df, nm, val)
# spillway elevations
elev = reach_data[reach_data['iseg']==447]['strtop'].values[0] # mendocino
param_utils.change_par_value(df, 'spill_447', elev)

elev = reach_data[reach_data['iseg']==449]['strtop'].values[0] # mendocino
param_utils.change_par_value(df, 'spill_449', elev)
