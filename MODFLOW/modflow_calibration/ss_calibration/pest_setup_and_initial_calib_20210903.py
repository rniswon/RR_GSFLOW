...
input_file = r".\slave_dir\input_param_20210820.csv"
...
fix_parms = ['lak_cond_1', 'lak_cond_2', 'pet_1', 'spill_447', 'spill_449']
fix_param_group = ['uzf_finf', 'uzf_vks']
...
# Update pest weights - 9/3/21
mask_gage_flow = pst.observation_data['obgnme'] == "GgFlo"
pst.observation_data.loc[mask_gage_flow, 'weight'] = 0
mask_pmpchg = pst.observation_data['obgnme'] == "PmpCHG"
pst.observation_data.loc[mask_pmpchg, 'weight'] = 0
mask_baseflow = pst.observation_data['obgnme'] == "Basflo"
pst.observation_data.loc[mask_baseflow, 'weight'] = pst.observation_data.loc[mask_baseflow, 'weight'] * 1.6
