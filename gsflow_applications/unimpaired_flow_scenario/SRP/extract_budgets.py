...
base_mf_out_folder = OPJ(root, 'model_archive', 'output', 'output.model1_full')
unimp_mf_out_folder = OPJ(thisFolder, 'unimpaired_1974_2018', 'output', 'output.model1_full')

listfile_base = './output/ouput.model1_full/srphm_full_base.lst'
if not os.path.isfile(listfile_base):
    print('{} not found'.format(listfile_base))
    getmodflow = False
listfile_unimpaired = './output/ouput.model1_full/srphm_full_unimp.lst'
if not os.path.isfile(listfile_unimpaired):
    print('{} not found'.format(listfile_unimpaired))
    getmodflow = False
gsflow_base = './output/ouput.model1_full/srphm_full_base_gsflow.csv'
if not os.path.isfile(gsflow_base):
    print('{} not found'.format(gsflow_base))
    getgsflow = False
gsflow_unimp = './output/ouput.model1_full/srphm_full_unimp_gsflow.csv'
