...
def main(script_ws, model_ws, results_ws):
    ...
    def analyze_gaining_losing_streams(sfr_output_file_path, agg_months, agg_months_name, agg_months_name_pretty):
        ...
        sfr_df_sum_wy_mean_all_file_path = os.path.join(results_ws, 'tables', sfr_df_sum_wy_mean_all_file_name)
        ...
        sfr_df_sum_wy_mean_all.to_csv(path_or_buf=sfr_df_sum_wy_mean_all_file_path, index=False)
