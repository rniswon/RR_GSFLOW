...
def main(script_ws, model_ws, results_ws):
    ...
    hist_baseline_flow_thresh_file = os.path.join(script_ws, '..', '..', '..', 'historical', 'hist_baseline', 'results', 'tables', 'func_flow_annual_metrics.csv')
    ...
    use_historical_baseline_flow_threshold_for_all = 1
