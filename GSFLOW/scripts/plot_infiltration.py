...
sim_infiltration_file = os.path.join(repo_ws, "GSFLOW", "PRMS", "output", "nhru_finf_cell_yearly.csv")
...
for date in dates:
    ...
    file_path = os.path.join(repo_ws, "GSFLOW", "results", "plots", "infiltration", file_name)
