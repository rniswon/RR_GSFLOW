...
def main(model_ws, results_ws, ss_archived_models_ws):
    ...
    # get ss model
    mf_ss_name_file = os.path.join(ss_archived_models_ws, "21_20220311", "mf_dataset", "rr_ss.nam")
    ...
    # get initial heads
    mf_ss_heads_file = os.path.join(ss_archived_models_ws, "21_20220311", "mf_dataset", "rr_ss_v0.hds")
    ...
    mf_tr.bas6.fn_path = os.path.join(model_ws, "modflow", "input", "rr_tr.bas")
