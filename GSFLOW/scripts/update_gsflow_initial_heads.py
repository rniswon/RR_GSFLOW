...
initial_heads_file = os.path.join(repo_ws, "GSFLOW", "scratch", "20230326_01", "GSFLOW", "worker_dir_ies", "gsflow_model_updated", "modflow", "output", "rr_tr.hds")
...
mf_bas_file = os.path.join(repo_ws, "GSFLOW", "scratch", "20230327_02", "GSFLOW", "worker_dir_ies", "gsflow_model_updated", "modflow", "input", "rr_tr.bas")
