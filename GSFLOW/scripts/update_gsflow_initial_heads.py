...
initial_heads_file = os.path.join(repo_ws, "GSFLOW", "scratch", "20221027_01", "modflow", "output", "rr_tr.hds")

# set mf name file for model to be updated
mf_name_file = os.path.join(repo_ws, "GSFLOW", "scratch", "20221029_01", "windows", "rr_tr.nam")

# set mf bas file for model to be updated
mf_bas_file = os.path.join(repo_ws, "GSFLOW", "scratch", "20221029_01", "modflow", "input", "rr_tr.bas")

# script settings
chosen_time_step = "mean_of_final_ten_years"  # options: final, mean_of_final_ten_years
