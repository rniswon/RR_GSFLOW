...
mendo_file = os.path.join(repo_ws, "GSFLOW", "modflow", "input", "Meno_bathy.dat")
sonoma_file = os.path.join(repo_ws, "GSFLOW", "modflow", "input", "Sonoma_bathy.dat")
...
def extrapolate_higher_stage_bathy(bathy_df, extrap_stage, out_file_name):
    ...
    # export
    file_path = os.path.join(repo_ws, "GSFLOW", "results", "tables", out_file_name)
