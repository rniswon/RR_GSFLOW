...
# set K zones file
K_zones_file = os.path.join(repo_ws, "GSFLOW", "scripts", "inputs_for_scripts", "K_zone_ids.dat")

# set subbasins file
subbasins_file = os.path.join(repo_ws, "GSFLOW", "scripts", "inputs_for_scripts", "subbasins.txt")

# set geologic zones file
geo_zones_file = os.path.join(repo_ws, "GSFLOW", "scripts", "inputs_for_scripts", "grid_info.npy")

# set output file csv
well_summary_not_ag_file = os.path.join(repo_ws, "MODFLOW", "init_files", "well_summary_not_ag.csv")
...
K_zones = zones = load_txt_3d(K_zones_file)
