...
budget_subbasin_annual_file = os.path.join(repo_ws, 'GSFLOW', 'results', 'tables', 'ag_budget_subbasin_annual.csv')

# set plot folder name
plot_folder = os.path.join(repo_ws, 'GSFLOW', 'results', 'plots', 'water_budget_ag')
