...
# set model workspace
model_ws = os.path.join(repo_ws, "GSFLOW", "scratch", "20230603_03", "GSFLOW", "worker_dir_ies", "gsflow_model_updated")
...
# write uzf file
mf.uzf.fn_path = os.path.join(model_ws, "modflow", "input", "rr_tr.uzf")
mf.uzf.write_file()