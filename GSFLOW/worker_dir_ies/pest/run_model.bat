...
rem set CONDAPATH=C:\Users\sadera\AppData\Local\Continuum\anaconda3
rem Define here the name of the environment
rem set ENVNAME=py37
...
rem python ..\scripts\gsflow_forward_model.py
"..\..\..\..\Miniconda3\python.exe" ..\scripts\gsflow_forward_model.py
