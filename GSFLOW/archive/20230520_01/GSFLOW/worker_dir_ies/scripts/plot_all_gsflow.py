...
#plot_hobs_output_compare_obs.main(script_ws, model_ws, results_ws, mf_name_file_type)
plot_hobs_output_combo_obs.main(script_ws, model_ws, results_ws, mf_name_file_type)
...
plot_water_budget_by_subbasin_group_gwbasin.main(script_ws, model_ws, results_ws, mf_name_file_type)

print('plot water budget by subbasin group: northern and southern basins')
plot_water_budget_by_subbasin_group_north_south.main(script_ws, model_ws, results_ws, mf_name_file_type)

print('plot water budget for entire watershed')
plot_water_budget_entire_watershed.main(script_ws, model_ws, results_ws, mf_name_file_type)
