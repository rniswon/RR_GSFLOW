...
def main(script_ws, model_ws, results_ws, mf_name_file_type, modflow_time_zero, start_date, end_date, modflow_time_zero_altformat, start_date_altformat, end_date_altformat):
    ...
    zone_budget_file = os.path.join(model_ws, "modflow", "output", "zone_budget_subbasins.csv.2.csv")
    ...
    plot_folder = os.path.join(results_ws, 'plots', 'water_budget_subbasins')
    ...
    # modflow_time_zero_alt_format = "01-01-1990"
    # start_date = "1998-10-01"
    # start_date_alt_format = "10-01-1998"
    # end_date = "2015-12-30"
    ...
    # add in mark west inflows for streamflow coming into subbasin 18
