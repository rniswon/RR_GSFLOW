...
def main(script_ws, model_ws, results_ws, mf_name_file_type, modflow_time_zero, start_date, end_date, modflow_time_zero_altformat, start_date_altformat, end_date_altformat):
    ...
    usace_sonoma_storage_data_file = os.path.join(script_ws, "script_inputs", "usace_lake_sonoma_storage.csv")
    ...
    redwood_valley_demand_file = os.path.join(script_ws, "script_inputs", "redwood_valley_demand_processed_20220725.csv")
    ...
    def plot_lake_budget_daily_cumul(sim_lake_budget, obs_lake_storage, lake_name, out_file_name, start_date_sim, end_date_sim):
    ...
    def examine_lake_mendo_obs(obs_flows_df, subbasin_2_sim_df, subbasin_3_sim_df, redwood_valley_demand_df, obs_lake_stage_df, sim_lake_budget,
                               obs_lake_storage, start_date_obs, end_date_obs, start_date_sim, end_date_sim):
    ...
    def plot_lake_budget_annual(sim_lake_budget, obs_lake_storage, lake_name, out_file_name, start_date_sim, end_date_sim):
    ...
    def plot_lake_budget_annual_diff(sim_lake_budget, obs_lake_storage, lake_name, out_file_name, start_date_sim, end_date_sim):
